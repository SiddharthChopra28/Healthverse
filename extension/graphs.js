...
export function makeCharts(arr1, arr2, arr3){
      ...
      datasets: [
        {
          type: 'line',
          label: 'CT Scan',
          data: arr1.map(mul100),
          fill: false,
          borderColor: 'rgb(181, 216, 86)',
          tension: 0.1
      ...
      },
{
          ...
          data: arr2.map(mul100),
          fill: false,
          borderColor: 'rgb(187, 59, 59)',
          tension: 0.1
      },
      {
        type: 'line',
        label: 'X-Ray Scan',
        data: arr3.map(mul100),
        fill: false,
